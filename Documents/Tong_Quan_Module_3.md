...
Nhà tuyển dụng đăng nhập vào bảng điều khiển và chọn một bài nộp bất kỳ. Tại thời điểm này, hệ thống tuân thủ tuyệt đối nguyên tắc "mù thông tin" – không một cái tên hay địa chỉ thư điện tử nào được hé lộ. Màn hình ngay lập tức chuyển sang trạng thái chia đôi (Split-view).
