...
const SUBMISSIONS_MOCK: Record<string, any> = {
  'sub-001': {
    ...
    challenge: {
      description:
        'Thiết kế một hệ thống distributed cache cho API có high traffic (10k req/s). Yêu cầu đảm bảo tính consistency cao và latency thấp.',
      difficulty: 'Medium',
      deadline: '28/06/2026',
  ...
  'sub-002': {
    ...
    statusClass: 'done',
    score: '86/100',
    files: [{ name: 'query_optimization.sql', type: 'file' }],
    github: null,
    feedback: [
    ...
    challenge: {
      description:
        'Phân tích và tối ưu hoá một query phức tạp trong PostgreSQL đang gây chậm toàn bộ hệ thống e-commerce.',
      difficulty: 'Hard',
      deadline: '25/06/2026',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card-base">
            <h2 className="text-lg font-semibold text-foreground mb-4 border-b-hairline border-border pb-2">
              Thông tin bài nộp
            </h2>
            <div className="grid grid-cols-2 gap-y-4 gap-x-8 text-sm">
              <div>
                <span className="block text-foreground-secondary text-xs uppercase tracking-wider mb-1">
                  Tên thử thách
                </span>
                ...
                <div className="pt-2">
                  ...
                  <div className="bg-background-tertiary p-3 rounded-md border border-border">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <code className="font-mono text-xs bg-background p-1 rounded text-foreground">
                        {data.github.commit}
                      </code>
                    </div>
                  </div>
        ...
        <div className="space-y-6">
          <div className="card-base bg-background-tertiary">
            <h2 className="text-md font-semibold text-foreground mb-4 border-b-hairline border-border pb-2">
              Thông tin Thử thách
            </h2>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`font-medium ${data.challenge.difficulty === 'Hard' ? 'text-error' : data.challenge.difficulty === 'Medium' ? 'text-warning' : 'text-success'}`}
                >
            ...
            <div className="mt-4 pt-4 border-t-hairline border-border">
              <span className="block text-foreground-secondary text-xs uppercase tracking-wider mb-2">
                Kỹ năng đánh giá
              </span>
