        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: '22px', fontWeight: '700', color: 'var(--green)' }}>
                Candidate
              </p>{' '}
              {/* Chữ to lên */}
              ...
              >
                <span style={{ fontSize: '13px', color: 'var(--text3)' }}>
                  ✓ Tham gia nhiều Challenge cùng lúc
                </span>{' '}
                {/* Chữ to lên */}
                <span style={{ fontSize: '13px', color: 'var(--text3)' }}>
                  ✓ Danh tính ẩn khi chấm điểm
                </span>
                <span style={{ fontSize: '13px', color: 'var(--text3)' }}>
                  ✓ Tích luỹ Dynamic Profile
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              <div style={{ fontSize: '48px' }}>🏢</div>
              <p style={{ fontSize: '22px', fontWeight: '700', color: 'var(--amber)' }}>
                Employer
              </p>{' '}
              {/* Chữ to lên */}
              <p style={{ fontSize: '14px', color: 'var(--text2)', lineHeight: '1.5' }}>
              ...
              >
                <span style={{ fontSize: '13px', color: 'var(--text3)' }}>
                  ✓ Chấm điểm Blind — không bias CV
                </span>{' '}
                {/* Chữ to lên */}
                <span style={{ fontSize: '13px', color: 'var(--text3)' }}>
                  ✓ Invite riêng qua mã Challenge
                </span>
                <span style={{ fontSize: '13px', color: 'var(--text3)' }}>
